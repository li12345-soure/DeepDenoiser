...
#include "b_d4_r4_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_B_D4_R4_MODEL_NAME          "b_d4_r4"
#define AI_B_D4_R4_ORIGIN_MODEL_NAME   "b_d4_r4_int8_logits"

/******************************************************************************/
#define AI_B_D4_R4_ACTIVATIONS_ALIGNMENT   (4)
#define AI_B_D4_R4_INPUTS_IN_ACTIVATIONS   (4)
#define AI_B_D4_R4_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_B_D4_R4_IN_NUM        (1)

AI_DEPRECATED
#define AI_B_D4_R4_IN \
  ai_b_d4_r4_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_B_D4_R4_IN_SIZE { \
  AI_B_D4_R4_IN_1_SIZE, \
}
#define AI_B_D4_R4_IN_SIZE_BYTES { \
  AI_B_D4_R4_IN_1_SIZE_BYTES, \
}
#define AI_B_D4_R4_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_B_D4_R4_IN_1_HEIGHT      (31)
#define AI_B_D4_R4_IN_1_WIDTH       (201)
#define AI_B_D4_R4_IN_1_CHANNEL     (2)
#define AI_B_D4_R4_IN_1_SIZE        (12462)
#define AI_B_D4_R4_IN_1_SIZE_BYTES  (12462)

/******************************************************************************/
#define AI_B_D4_R4_OUT_NUM       (1)

AI_DEPRECATED
#define AI_B_D4_R4_OUT \
  ai_b_d4_r4_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_B_D4_R4_OUT_SIZE { \
  AI_B_D4_R4_OUT_1_SIZE, \
}
#define AI_B_D4_R4_OUT_SIZE_BYTES { \
  AI_B_D4_R4_OUT_1_SIZE_BYTES, \
}
#define AI_B_D4_R4_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_B_D4_R4_OUT_1_HEIGHT      (31)
#define AI_B_D4_R4_OUT_1_WIDTH       (201)
#define AI_B_D4_R4_OUT_1_CHANNEL     (2)
#define AI_B_D4_R4_OUT_1_SIZE        (12462)
#define AI_B_D4_R4_OUT_1_SIZE_BYTES  (12462)

/******************************************************************************/
#define AI_B_D4_R4_N_NODES (29)
 ...
 * @ref ai_b_d4_r4_create. Both the activations memory buffer 
 ...
 * using @ref ai_b_d4_r4_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_b_d4_r4_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_b_d4_r4_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_B_D4_R4_*
 * defines into file @ref b_d4_r4.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
